package com.machmoum.examen.adapters;
...
import com.machmoum.examen.EmployeActivity;
...
public class EmployeAdapter extends RecyclerView.Adapter<EmployeAdapter.EmployeViewHolder> {
    ...
    public void loadEmployes(){
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://192.168.3.156:9091/api/employe",
